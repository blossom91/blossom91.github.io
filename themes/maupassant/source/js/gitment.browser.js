    ...
    /** ****/ ([
        ...
        /** */ function(module, exports, __webpack_require__) {
            ...
            /* WEBPACK VAR INJECTION */(function(global) {
                ...
                var actionFieldDecorator = createClassPropertyDecorator((target, key, value, args, originalDescriptor) => {
                ...
                var boundActionDecorator = createClassPropertyDecorator((target, key, value) => {
                ...
                var action = function action(arg1, arg2, arg3, arg4) {
                    ...
                    return namedActionDecorator(arg2)(...arguments)
                }
                ...
                action.bound = function boundAction(arg1, arg2, arg3) {
                    ...
                    return boundActionDecorator(...arguments)
                }
                ...
                function createComputedDecorator(compareStructural) {
                    return createClassPropertyDecorator((target, name, _, __, originalDescriptor) => {
                ...
                function createTransformer(transformer, onCleanup) {
                    ...
                    var Transformer = (function(_super) {
                        ...
                        function Transformer(sourceIdentifier, sourceObject) {
                            var _this = _super.call(this, () => transformer(sourceObject), undefined, false, 'Transformer-' + transformer.name + '-' + sourceIdentifier, undefined) || this
                ...
                function createObservable(v) {
                    ...
                    if (typeof arguments[1] === 'string') return deepDecorator(...arguments)
                ...
                var IObservableFactories = (function() {
                    ...
                    IObservableFactories.prototype.shallow = function() {
                        if (arguments.length < 2) {
                            ...
                            return shallowDecorator(...arguments)
                        }
                    }
                    IObservableFactories.prototype.deep = function() {
                        if (arguments.length < 2) {
                            ...
                            return deepDecorator(...arguments)
                        }
                    }
                    IObservableFactories.prototype.struct = function() {
                        if (arguments.length < 2) {
                            ...
                            return deepStructDecorator(...arguments)
                        }
                    }
                ...
                observable.ref.struct = function() {
                    if (arguments.length < 2) {
                        ...
                        return refStructDecorator(...arguments)
                    }
                }
                ...
                function createDecoratorForEnhancer(enhancer) {
                    invariant(!!enhancer, ':(')
                    return createClassPropertyDecorator((target, name, baseValue, _, baseDescriptor) => {
                ...
                function toJS(source, detectCycles, __alreadySeen) {
                    ...
                    if (isObservable(source)) {
                        ...
                        if (isObservableArray(source)) {
                            var res = cache([])
                            var toAdd = source.map(value => toJS(value, detectCycles, __alreadySeen))
                        ...
                        if (isObservableMap(source)) {
                            var res_1 = cache({})
                            source.forEach((value, key) => res_1[key] = toJS(value, detectCycles, __alreadySeen))
                            return res_1
                        }
                ...
                function transaction(action, thisArg) {
                    ...
                    return runInTransaction(...arguments)
                }
                ...
                var ComputedValue = (function() {
                    ...
                    ComputedValue.prototype.whyRun = function() {
                        ...
                        var observing = unique(this.isComputing ? this.newObserving : this.observing).map(dep => dep.name)
                        var observers = unique(getObservers(this).map(dep => dep.name))
                ...
                function invariantLOS(observable, msg) {
                    var min = getObservers(observable).reduce((a, b) => Math.min(a, b.dependenciesState), 2)
                ...
                var Reaction = (function() {
                    ...
                    Reaction.prototype.reportExceptionInDerivation = function(error) {
                        ...
                        globalState.globalReactionErrorHandlers.forEach(f => f(error, _this))
                    }
                    ...
                    Reaction.prototype.whyRun = function() {
                        var observing = unique(this._isRunning ? this.newObserving : this.observing).map(dep => dep.name)
                ...
                var ObservableArrayAdministration = (function() {
                    ...
                    ObservableArrayAdministration.prototype.spliceWithArray = function(index, deleteCount, newItems) {
                        ...
                        newItems = newItems.map(v => _this.enhancer(v, undefined))
                ...
                var ObservableArray = (function(_super) {
                    ...
                    ObservableArray.prototype.reverse = function() {
                        ...
                        return clone.reverse(...arguments)
                    }
                    ObservableArray.prototype.sort = function(compareFn) {
                        this.$mobx.atom.reportObserved()
                        var clone = this.slice()
                        return clone.sort(...arguments)
                    }
                ...
                ['every', 'filter', 'forEach', 'indexOf', 'join', 'lastIndexOf', 'map', 'reduce', 'reduceRight', 'slice', 'some'].forEach(funcName => {
                ...
                var ObservableMap = (function() {
                    ...
                    ObservableMap.prototype.entries = function() {
                        var _this = this
                        return arrayAsIterator(this._keys.map(key => [key, _this.get(key)]))
                    }
                    ObservableMap.prototype.forEach = function(callback, thisArg) {
                        var _this = this
                        this.keys().forEach(key => callback.call(thisArg, _this.get(key), key, _this))
                    }
                    ObservableMap.prototype.merge = function(other) {
                        ...
                        runInTransaction(() => {
                            if (isPlainObject(other)) {
                                Object.keys(other).forEach(key => _this.set(key, other[key]))
                                ...
                                other.forEach((value, key) => _this.set(key, value))
                    ...
                    ObservableMap.prototype.toJS = function() {
                        var _this = this
                        var res = {}
                        this.keys().forEach(key => res[key] = _this.get(key))
                        return res
                    }
                    ...
                    ObservableMap.prototype.toString = function() {
                        var _this = this
                        return this.name + '[{ ' + this.keys().map(key => key + ': ' + ('' + _this.get(key))).join(', ') + ' }]'
                    }
                ...
                function createClassPropertyDecorator(onInitialize, _get, _set, enumerable, allowCustomArguments) {
                    ...
                    if (allowCustomArguments) {
                        return function() {
                            if (quacksLikeADecorator(arguments)) return classPropertyDecorator(...arguments)
        ...
        /** */ function(module, exports, __webpack_require__) {
            ...
            function renderComments(_ref2, instance) {
                ...
                comments.forEach(comment => {
                    ...
                    var likedReaction = commentReactions[comment.id] && commentReactions[comment.id].find(reaction => reaction.content === 'heart' && reaction.user.login === user.login)
                    if (likedReaction) {
                        likeButton.classList.add('liked')
                        likeButton.onclick = function() {
            ...
            var Gitment = (function() {
                ...
                _createClass(Gitment, [{
                    ...
                    value: function init() {
                        ...
                        return this.createIssue().then(() => _this2.loadComments()).then(comments => {
                    ...
                    value: function useTheme() {
                        ...
                        renderers.forEach(renderer => extendRenderer(_this3, renderer))
                    }
                }, {
                    key: 'update',
                    value: function update() {
                        ...
                        return Promise.all([this.loadMeta(), this.loadUserInfo()]).then(() => Promise.all([_this4.loadComments().then(() => _this4.loadCommentReactions()), _this4.loadReactions()])).catch(e => _this4.state.error = e)
                    }
                }, {
                    key: 'markdown',
                    ...
                    value: function post(body) {
                        ...
                        return this.getIssue().then(issue => _utils.http.post(issue.comments_url, { body }, '')).then(data => {
                    ...
                    value: function loadComments() {
                        ...
                        return this.getIssue().then(issue => _utils.http.get(issue.comments_url, { page, per_page: _this8.perPage }, '')).then(comments => {
                    ...
                    value: function loadUserInfo() {
                        ...
                        return _utils.http.get('/user').then(user => {
                    ...
                    value: function unlike() {
                        ...
                        var index = reactions.findIndex(reaction => reaction.user.login === user.login)
                        return _utils.http.delete('/reactions/' + reactions[index].id).then(() => {
                    ...
                    value: function likeAComment(commentId) {
                        ...
                        var comment = this.state.comments.find(comment => comment.id === commentId)
